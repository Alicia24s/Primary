...
# import cv2
import json
from recognition import ActionSystem
...
# done_image = cv2.imread('done.png', 0)
# not_done_image = cv2.imread('not_done.png', 0)
# print("Done Image:",len(done_image),"x", len(done_image[0]),"x",len(done_image[0][0]))
# print("Not-Done Image:",len(not_done_image),"x", len(not_done_image[0]),"x",len(not_done_image[0][0]))
...
def video_feed():
    return Response(gen(ActionSystem()),
